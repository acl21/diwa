...
class TrainAgent:
    def __init__(self, cfg):
        ...
        self.furniture_sparse_reward = (
            cfg.env.specific.get("sparse_reward", False) if "specific" in cfg.env else False
        ...
        self.traj_plotter = hydra.utils.instantiate(cfg.train.plotter) if "plotter" in cfg.train else None
