...
def get_score_fn(
    ...
    def score_fn(x, t, **kwargs):
        ...
        if not predict_epsilon:  # get epsilon first from predicted mu
            score = (
                -(x - score * sde.sqrt_alphas[t.long()][:, None, None]) / sde.discrete_betas[t.long()][:, None, None]
            )
        else:
    ...
    def reverse(self, score_fn, probability_flow=False):
        ...
        class RSDE(self.__class__):
            ...
            def sde(self, x, t, **kwargs):
                ...
                drift = drift - diffusion[:, None, None] ** 2 * score * (0.5 if self.probability_flow else 1.0)
            ...
            def discretize(self, x, t):
                ...
                rev_f = f - G[:, None] ** 2 * score_fn(x, t) * (0.5 if self.probability_flow else 1.0)
