...
from diwa.model.diffusion.diffusion import DiffusionModel, Sample
from diwa.model.diffusion.sampling import extract, make_timesteps
...
class VPGDiffusion(DiffusionModel):
    ...
    def step(self):
        ...
        if (
            ...
            for param in self.actor.parameters():
                param.requires_grad = False
            logging.info(f"Finished annealing fine-tuning denoising steps to {self.ft_denoising_steps}")
