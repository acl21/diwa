...
from diwa.utils.transforms import NormalizeVectorMinMax, UnnormalizeVectorMinMax
...
class CALVINEnvRunner(object):
    ...
    def get_normalizers(self, device, normalization_path=None):
        if normalization_path is None:
            normalization_path = "/path/to/statistics/file.yaml"  # Update with actual path
        ...
        return (
            robot_obs_normalizer,
            scene_obs_normalizer,
            robot_obs_unnormalizer,
            scene_obs_unnormalizer,
        )
